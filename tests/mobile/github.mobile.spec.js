...
describe('Mobile Navigation on GitHub.com', () => {
    ...
    it('should sign in on github.com @mobile', async () => {
        await browser.url('/')
    ...
    it('should subscribe on github.com @mobile', async () => {
        await browser.url('/')
    ...
    it('should search on github.com @mobile', async () => {
        await browser.url('/')
    ...
    it('should check pricing on github.com @mobile', async () => {
        await browser.url('/')
        ...
        await expect(MainPage.compareFeaturesTitle).toBeDisplayed()
    })
